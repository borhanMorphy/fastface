...
class MobileNetV2(torchvision.models.mobilenet.MobileNetV2):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.feature_layers_1 = torch.nn.Sequential(
            *self.features[:4]
        )
        self.feature_layers_2 = torch.nn.Sequential(
            *self.features[4:7]
        )
        self.feature_layers_3 = torch.nn.Sequential(
            *self.features[7:14]
        )
        self.feature_layers_4 = torch.nn.Sequential(
            *self.features[14:-1]
        )
