...
class PANetTiny(nn.Module):
    def __init__(self, features: int):
        ...
        self.branch_1_conv_block_2 = conv1x1(features, features//2)
        self.branch_1_conv_block_3 = conv3x3(features//2, features)

        self.branch_2_conv_block_1 = conv1x1(features//2, features//4)
    ...
    def forward(self, x: torch.Tensor, residual: torch.Tensor) -> Tuple[torch.Tensor, torch.Tensor]:
        ...
        out = F.interpolate(out, size=residual.shape[2:]) # 13x13 => 26x26
