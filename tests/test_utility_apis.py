...
@pytest.mark.parametrize("func",
    [
        "get_cache_dir", "get_model_cache_dir",
        "get_data_cache_dir", "get_checkpoint_cache_dir"
    ]
)
def test_cache_func_exists(func: str):
    assert func in dir(ff.utils.cache), "{} not found in the fastface.utils.cache".format(func)
